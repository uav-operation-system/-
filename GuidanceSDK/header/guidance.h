 ...
 *     @brief Callback function prototype. The developer must write his/her own callback function in this
 form. In order to achieve best performance, it is suggested not performing any time-consuming processing in the callback function, but only copying the data out. 
 Otherwise the transfer frequency might be slowed down.  
 *     @param `event_type` use it to identify the data:image,imu,ultrasonic,velocity or obstacle  *     @param `data_len` length of the input data
distance
